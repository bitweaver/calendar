...
$smarty->assign('displayedbitcals', $_SESSION['CalendarViewBitCals']);
...
if ($_REQUEST["editmode"]) {
	...
	if ($thatcal["customlanguages"] == 'y') {
		$languages = $gBitSystem->list_languages();
	}
...
if ($_SESSION['CalendarViewBitCals']) {
	$listbitevents = $calendarlib->listTikiItems($_SESSION['CalendarViewBitCals'], $gBitUser->mUserId, $viewstart, $viewend, 0, 50, 'name_desc', '');
} else {
	$listbitevents = array();
}
